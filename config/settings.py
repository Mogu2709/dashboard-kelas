...
# Railway injects RAILWAY_STATIC_URL, we need to allow that domain too
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'attendance.context_processors.izin_pending_count',
...
# ── Database ──────────────────────────────────────────────────────────────────
# Kalau ada DATABASE_URL (Railway), pakai itu. Kalau tidak, pakai SQLite lokal.
...
if CLOUDINARY_CLOUD_NAME:
    ...
    # FIX BUG: Django 4.2+ butuh STORAGES dict agar whitenoise staticfiles berjalan
    STORAGES = {
        "default": {
